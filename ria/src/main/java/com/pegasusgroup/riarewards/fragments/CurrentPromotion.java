 ...
 */
public class CurrentPromotion extends BaseFragment implements FacebookShareListener,
        PromotionListener {
    ...
    protected View getLayoutResource() {
        return LayoutInflater.from(mContext).inflate(R.layout.fragment_current_promotion, container, false);
    }
    ...
    protected void initComponents(View view) {
        ...
        FacebookShareListener facebookShareListener = this;
        PromotionListener promotionListener = this;
        promotionAdapter = new PromotionAdapter(mContext, promotionMds, facebookShareListener, promotionListener);

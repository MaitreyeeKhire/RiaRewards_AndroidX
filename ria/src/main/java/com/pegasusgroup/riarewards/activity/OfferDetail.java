...
public class OfferDetail extends BaseAppCompatActivity {
        ...
        cmdBuyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (cmdBuyNow.getText().toString().equalsIgnoreCase("Redeem Now")) {
                    ...
                    Intent intent = new Intent(OfferDetail.this, VoucherWebView.class);
    ...
    private void redeemTracker(String product_id) {
        try {
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(OfferDetail.this);
            try {
...
//                        txtHighLight.setText(singleCategoryMd.getHighlight());
                        ...
                        if (!imageUrl.isEmpty()) {
                            Glide.with(OfferDetail.this).load(imageUrl).fitCenter()

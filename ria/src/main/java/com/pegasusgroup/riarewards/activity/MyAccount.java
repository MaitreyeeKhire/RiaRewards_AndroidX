...
public class MyAccount extends BaseAppCompatActivity {
...
//        edtAddress = findViewById(R.id.edtAddress);
        ...
        note = "<html><body style=\"text-align:justify\"><b>NOTE:</b> To amend the below details, please contact Ria on <b>1800 701 488</b> or <b>riarewards@riafinancial.com</b></body></Html>";
//        note = "NOTE: To amend the below details, please contact Ria on 1800 701 488 or riarewards@riafinancial.com";
    ...
    protected void setListeners() {
        ...
        txtContactUs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startNextActivity(MyAccount.this, ContactUs.class);
            }
        });
        ...
        if (sessionManager.getProfileImage().isEmpty()) {
            Glide.with(MyAccount.this).load(R.drawable.profile_image).asBitmap().centerCrop().into(new BitmapImageViewTarget(imgProfile) {
                @Override
                protected void setResource(Bitmap resource) {
                    RoundedBitmapDrawable circularBitmapDrawable =
                            RoundedBitmapDrawableFactory.create(MyAccount.this.getResources(), resource);
                    ...
                    try {
                        ...
                        if (response != null) {
                            ...
                            if (jsonObject.has("status")) {
                                ...
                                if (code.equals("200")) {
                                    Glide.with(MyAccount.this).load(jsonObject.getString("user_image")).asBitmap().centerCrop().into(new BitmapImageViewTarget(imgProfile) {
                                        @Override
                                        protected void setResource(Bitmap resource) {
                                            RoundedBitmapDrawable circularBitmapDrawable =
                                                    RoundedBitmapDrawableFactory.create(MyAccount.this.getResources(), resource);
                    ...
                    try {
                        ...
                        if (response != null) {
                            ...
                            if (jsonObject.has("status")) {
                                String code = jsonObject.getString("status");
                                if (code.equals("200")) {
                                    Toast.makeText(MyAccount.this, jsonObject.getString("msg"), Toast.LENGTH_SHORT).show();
                                    onBackPressed();
                                }
                            }
                        }

...
public class Review extends BaseAppCompatActivity {
    ...
    protected void initComponents() {
        ...
        reviewAdapter = new ReviewAdapter(Review.this, reviewMds);
        lastTransactionAdapter = new LastTransactionAdapter(Review.this, transactionHistoryMds);
    ...
    protected void setListeners() {
        ...
        txtCustomerReview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                txtCustomerReview.setBackground(getDrawable(R.drawable.my_order_selected_button));
                txtCustomerReview.setTextColor(getResources().getColor(R.color.white));
                txtLastTransaction.setBackground(getDrawable(R.drawable.my_order_unselected_button));
        ...
        txtLastTransaction.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                txtLastTransaction.setBackground(getDrawable(R.drawable.my_order_selected_button));
                txtLastTransaction.setTextColor(getResources().getColor(R.color.white));
                txtCustomerReview.setBackground(getDrawable(R.drawable.my_order_unselected_button));
            ...
            public void onClick(View v) {
                if (!getText(edtReview).isEmpty()) {
                    if (ratingBar.getRating() != 0.0f) {
                        ...
                        Toast.makeText(Review.this, "Please rate a star", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(Review.this, "Please write a review", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
                    ...
                    try {
                        ...
                        if (response != null) {
                            ...
                            if (jsonObject.has("status")) {
                                ...
                                Toast.makeText(Review.this, jsonObject.getString("msg"), Toast.LENGTH_SHORT).show();
                            }
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
